...
这是一个非官方的Python包装器 `Binance exchange REST API v3 <https://binance-docs.github.io/apidocs/spot/en>`_. 我决不隶属于币安，使用风险自负。

如果你来这里找 `Binance exchange <https://www.binance.com/?ref=10099792>`_ 购买加密货币，然后 `go here <https://www.binance.com/?ref=10099792>`_.
如果你想自动化与Binance的交互，请坚持。

如果您对Binance的新DEX Binance Chain感兴趣，请查看我的 `python-binance-chain library <https://github.com/sammchardy/python-binance-chain>`_
